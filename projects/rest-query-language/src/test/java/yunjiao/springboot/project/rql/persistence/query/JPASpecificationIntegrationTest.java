package yunjiao.springboot.project.rql.persistence.query;

import yunjiao.springboot.project.rql.persistence.dao.GenericSpecificationsBuilder;
import yunjiao.springboot.project.rql.persistence.dao.UserRepository;
import yunjiao.springboot.project.rql.persistence.dao.UserSpecification;
import yunjiao.springboot.project.rql.persistence.dao.UserSpecificationsBuilder;
import yunjiao.springboot.project.rql.persistence.model.User;
import yunjiao.springboot.project.rql.web.util.CriteriaParser;
import yunjiao.springboot.project.rql.web.util.SearchOperation;
