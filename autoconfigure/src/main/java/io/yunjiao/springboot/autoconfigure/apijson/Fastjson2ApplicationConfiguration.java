...
import io.yunjiao.springboot.autoconfigure.apijson.condition.ApllicationCondition;
import io.yunjiao.springboot.autoconfigure.apijson.fastjson2.*;
...
@AutoConfigureAfter({ApijsonInitConfiguration.class})
@Conditional(ApllicationCondition.OnFastjson2.class)
public class Fastjson2ApplicationConfiguration {
    ...
    public void postConstruct() {
        log.info("Fastjson2 Application Configuration");
    }
