package yunjiao.springboot.example.querydsl;

import yunjiao.springboot.example.querydsl.sql.User;
import yunjiao.springboot.example.querydsl.sql.UserSQLService;
